...
public class SteemManager {
	...
	public static void uploadNews(News news) {
			...
			commentOperation.setPermlink(firstTag + new Random().nextInt(10000));
			...
			commentOperation.setJsonMetadata("{\"tags\":[\"cryptocurrency\",\"ripple\"],\"app\":\"steemit/0.1\",\"format\":\"markdown\"}");
